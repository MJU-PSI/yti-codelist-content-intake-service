...
CREATE UNIQUE INDEX code_codevalue_unique_per_codescheme ON code (codevalue, codescheme_id);
CREATE UNIQUE INDEX codescheme_codevalue_unique_per_coderegistry ON codescheme (codevalue, coderegistry_id);