...
CREATE TABLE codescheme_variant
(
...
CREATE UNIQUE INDEX codescheme_id_variant_codescheme_id_unique_combo ON codescheme_variant (codescheme_id, variant_codescheme_id);
